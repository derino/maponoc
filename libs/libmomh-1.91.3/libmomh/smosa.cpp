...
template < class TProblemSolution > TSMOSA < TProblemSolution >::TSMOSA()
{
...
template < class TProblemSolution >
    ...
    double FinalTemperature, double TemperatureDecreaseCoefficient, int MovesOnTemperatureLevel)
{
...
template < class TProblemSolution > void TSMOSA < TProblemSolution >::FindInitialSolution()
{
...
template < class TProblemSolution > void TSMOSA < TProblemSolution >::UpdateWeightVector()
{
...
//      GeneratingSolution->WeightVector = GetRandomWeightVector ();
    ...
    GeneratingSolution->GeneratingSolution->WeightVector = GeneratingSolution->WeightVector;
    GeneratingSolution->GeneratingSolution->WeightVector.Rescale(this->pNondominatedSet->ApproximateIdealPoint,
        this->pNondominatedSet->ApproximateNadirPoint);
}

template < class TProblemSolution > void TSMOSA < TProblemSolution >::Run()
{
    // Callback function
    this->Start();
...
template < class TProblemSolution > void TDisplaySMOSA < TProblemSolution >::End()
{
...
template < class TProblemSolution > void TDisplaySMOSA < TProblemSolution >::NewNondominatedSolutionFound()
{
}

template < class TProblemSolution > void TDisplaySMOSA < TProblemSolution >::TemperatureDecreased()
{
