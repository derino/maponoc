...
#ifndef __SOLUTIONSSET_H
#define __SOLUTIONSSET_H
...
class TSolutionsSet:public vector < TSolution * >
{
  ...
  public:
    ...
    *    in the set of solutions */
    ...
    void OutperformanceCompare(TSolutionsSet & Set2, bool & bWeak1By2, bool & bStrong1By2, bool & bComplete1By2,
        bool & bWeak2By1, bool & bStrong2By1, bool & bComplete2By1);
