...
void TSolutionsSet::OutperformanceCompare(TSolutionsSet & Set2, bool & bWeak2By1, bool & bStrong2By1,
    bool & bComplete2By1, bool & bWeak1By2, bool & bStrong1By2, bool & bComplete1By2)
{
    ...
    for (i = 0; i < size(); i++)
    {
        ...
        bool bScanned = false;
        unsigned int j;
        for (j = 0; (j < Set2.size()) && !bScanned; j++)
        {
            if ((*this)[j] == NULL)
            {
                continue;
