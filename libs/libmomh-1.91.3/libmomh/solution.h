...
enum TCompare
{ _Dominating, _Dominated, _Nondominated, _Equal };
...
class TPoint
{
  public:
    ...
    *    It may also return _Nondominated or _Equal */
    /** OD added virtual */
    virtual TCompare Compare(TPoint & Point);

    /**    Returns value of the linear scalarizing function (weighted sum) 
    *    defined by the given weight vector and reference point */
    double LinearScalarizingFunction(TWeightVector & WeightVector, TPoint & ReferencePoint);

    /**    Returns value of the Chebycheff scalarizing function 
    *    defined by the given weight vector and reference point */
    double ChebycheffScalarizingFunction(TWeightVector & WeightVector, TPoint & ReferencePoint);
