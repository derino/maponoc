...
// TMOGLS.h: interface for the TMOGLS class.
//
//////////////////////////////////////////////////////////////////////
...
*    www-idss.cs.put.poznan.pl/~jaszkiewicz/MOGLS.
...
*/
template < class TProblemSolution > class TMOGLS:public THGABase < TProblemSolution >
{
  protected:
  ...
  public:
    ...
    *    solutions will be determined automatically by TMOGLS::Run.
...
template < class TProblemSolution > class TDisplayMOGLS:public TMOGLS < TProblemSolution >
{
  protected:
    /** Displays:
