...
class TNondominatedSet:public TSolutionsSet
{
  private:
     ...
     **/
    double ClusterDistance(IntVector iCluster1, IntVector iCluster2, int iSpaceType, bool bScalarize,
   ...
   /** Get centroid of some cluster
     ...
     **/
    int GetCentroid(IntVector iCluster, int iSpaceType, bool bScalarize, vector < double >&dIdeal,
  ...
  protected:
     ...
     **/
         ...
         bool ReduceIndividuals(unsigned int iPopulationSize, vector < int >&iReducedIndividuals, int iSpaceType,
        bool bScalarize);
