...
template < class TProblemSolution >
    ...
    int NumberOfIterations, TScalarizingFunctionType ScalarizingFunctionType)
{
...
template < class TProblemSolution > void TMOGLS < TProblemSolution >::Run()
{
    // Callback function
    this->Start();
    ...
    do
    {
        ...
        int isol;
        for (isol = 0; isol < this->MainPopulation.size(); isol++)
        {
        ...
        TProblemSolution *Solution =
            new TProblemSolution(*(TProblemSolution *) this->TempPopulation[isol1],
            *(TProblemSolution *) this->TempPopulation[isol2],
...
template < class TProblemSolution > void TDisplayMOGLS < TProblemSolution >::End()
{
...
template < class TProblemSolution > void TDisplayMOGLS < TProblemSolution >::NewNondominatedSolutionFound()
{
...
template < class TProblemSolution > void TDisplayMOGLS < TProblemSolution >::InitialPopulationFound()
{
