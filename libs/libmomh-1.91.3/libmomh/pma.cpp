...
template < class TProblemSolution > void TDisplayPMA < TProblemSolution >::End()
{
...
template < class TProblemSolution > void TDisplayPMA < TProblemSolution >::NewNondominatedSolutionFound()
{
    cout << this->pNondominatedSet->iSetSize << '\t';
    int iobj;
    for (iobj = 0; iobj < NumberOfObjectives; iobj++)
...
template < class TProblemSolution > void TDisplayPMA < TProblemSolution >::InitialPopulationFound()
{
