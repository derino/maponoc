...
#ifndef __SABASE_CPP_
#define __SABASE_CPP_
    ...
    TScalarizingFunctionType ScalarizingFunctionType, TWeightVector & WeightVector, bool bUpdateNondominatedSet)
{
    ...
    double CurrentScalarizingFunctionValue = Solution->ScalarizingFunction(ReferencePoint);
        ...
        for (iMove = 0; iMove < MovesOnTemperatureLevel; iMove++)
        {
            ...
            if (NewScalarizingFunctionValue <= 0)
                ...
                AcceptanceProbability =
                    exp(CurrentScalarizingFunctionValue - NewScalarizingFunctionValue / Temperature);
            ...
            if ((rand() % 10000) / 10000.0 < AcceptanceProbability)
            {
                ...
                if (BestSolution.ScalarizingFunction(ReferencePoint) > Solution->ScalarizingFunction(ReferencePoint))
