...
template < class TProblemSolution > class TNSGAIIC:public TParetoBase < TProblemSolution >
{
  ...
  public:
    ...
    *    a specialization of NSGAIIC
    *
    *    Specialization of NSGAIIC class 
    *    should call this method whenever a generation
    *    is finished */
    virtual void NewGenerationFound()
    {
	// emit signal if new generation is found
      this->signal_new_generation_found.emit(this->m_iGeneration, this->pNondominatedSet, &this->m_oPPopulation, &this->m_oQPopulation);
    };
    sigc::signal<void, int, void*, void*, void*> signal_new_generation_found;
    /** /OD */
};
