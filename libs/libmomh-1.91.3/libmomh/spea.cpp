...
template < class TProblemSolution > TSPEA < TProblemSolution >::TSPEA()
{
...
template < class TProblemSolution >
    ...
    double dMutationProbability, int iNondominatedPopulationSize, int iClusteringLevel, bool bScalarize)
{
    ...
    m_iNondominatedPopulationSize = iNondominatedPopulationSize;
    m_iClusteringLevel = iClusteringLevel;
    m_bScalarize = bScalarize;

    m_iGeneration = 0;
}

template < class TProblemSolution > void TSPEA < TProblemSolution >::Run()
{
    ...
    do
    {
        ...
        for (i = 0; i < this->m_iPopulationSize; i++)
        {
            ...
            // recombination                
            pOffspring =
                new TProblemSolution(*(TProblemSolution *) oMatingPull[iSolution1],
                *(TProblemSolution *) oMatingPull[iSolution2]);
...
template < class TProblemSolution > void TDisplaySPEA < TProblemSolution >::End()
{
...
template < class TProblemSolution > void TDisplaySPEA < TProblemSolution >::NewNondominatedSolutionFound()
{
...
template < class TProblemSolution > void TDisplaySPEA < TProblemSolution >::NewGenerationFound()
{
