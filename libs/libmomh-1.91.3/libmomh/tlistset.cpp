...
template < class TProblemSolution > TListSet < TProblemSolution >::TListSet():TNondominatedSet()
{
...
template < class TProblemSolution > bool TListSet < TProblemSolution >::Update(TNondominatedSet & NondominatedSet)
{
    bool bAdded = false;
...
template < class TProblemSolution > void TListSet < TProblemSolution >::UpdateNadir(int iRemovedSolution)
{
    int iobj;
...
template < class TProblemSolution > void TListSet < TProblemSolution >::DeleteAll()
{
...
template < class TProblemSolution > void TListSet < TProblemSolution >::GetRandomSolution(TSolution * &pSolution)
{
    int iIndex = 0;
