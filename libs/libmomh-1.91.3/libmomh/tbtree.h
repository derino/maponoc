...
class TBTree
{
  ...
  private:
     ...
     * @return true - success, false - error
     **/
    bool GetRecursiveGreater(TBNode * pNode, unsigned int iLevel, bool bEqual, vector < bool > &oValue,
     ...
     * @return true - success, false - error
     **/
    bool GetRecursiveLesser(TBNode * pNode, unsigned int iLevel, bool bEqual, vector < bool > &oValue,
        vector < TQuadNode * >&oNodes);
};
