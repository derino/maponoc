...
#ifndef __MOMHSOLUTION_H_
#define __MOMHSOLUTION_H_
...
class TMOMHSolution:public TSolution
{
  ...
  TMOMHSolution(TMOMHSolution & Parent1, TMOMHSolution & Parent2):TSolution()
    ...
    *    your problem.
    */
  TMOMHSolution(TMOMHSolution & Parent1, TMOMHSolution & Parent2, TScalarizingFunctionType ScalarizingFunctionType, TPoint & ReferencePoint, TWeightVector WeightVector, TNondominatedSet & NondominatedSet):TSolution
        ()
    {
        SetWeightVector(WeightVector);
        SetScalarizingFunctionType(ScalarizingFunctionType);
    ...
    * @return computed distance
    */
    virtual double ObjectiveValuesDistance(TMOMHSolution & oSolution, bool bScalarize, vector < double >&dIdeal,
